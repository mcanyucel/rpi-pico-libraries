/**
 * @file ssd1306_i2c.h
 * @brief SSD1306 OLED Display I2C Driver Header - Refactored Stateless API
 * @version 2.0
 * @date 2026-01-16
 * 
 * Stateless driver API matching SH1106 design pattern.
 * No device instance required - uses compile-time configuration.
 * 
...
#define SSD1306_I2C_INSTANCE    i2c0        ///< I2C instance (i2c0 or i2c1)
#endif

#ifndef SSD1306_I2C_ADDR
#define SSD1306_I2C_ADDR        0x3C        ///< I2C address (0x3C or 0x3D)
#endif

#ifndef SSD1306_SDA_PIN
#define SSD1306_SDA_PIN         16          ///< GPIO pin for SDA
#endif

#ifndef SSD1306_SCL_PIN
#define SSD1306_SCL_PIN         17          ///< GPIO pin for SCL
#endif

#ifndef SSD1306_I2C_CLK
#define SSD1306_I2C_CLK         400         ///< I2C clock in kHz
#endif
...
#define SSD1306_FULL_SCREEN_AREA() ((struct render_area){  \
    .start_col = 0,                                         \
 ...
 * 
 * Uses compile-time configuration (SSD1306_I2C_INSTANCE, SSD1306_SDA_PIN, etc.)
 ...
 * 
 * Turns off display and resets GPIO pins to prevent backfeeding.
 */
